...
**Fase 1** (de 22) — base del proyecto: React + TypeScript + Vite
funcionando localmente, estructura de carpetas por dominio, cliente de
Supabase preparado (sin conectar todavía a un proyecto real).
